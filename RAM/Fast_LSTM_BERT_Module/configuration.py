...
from longling.ML.MxnetHelper.toolkit.optimizer_cfg import get_optimizer_cfg, \
    get_update_steps
from longling.ML.MxnetHelper.toolkit.select_exp import block_embedding as _select
...
class Configuration(parser.Configuration):
    ...
    vec_dir = path_append("$root", "data", "vec")
    # vec_dir = path_append("$data_dir", "vec")
    ...
    #     "learning_rate": 0.04,
    # }
    optimizer, optimizer_params = get_optimizer_cfg("word_embedding")
    lr_params = {}
    # lr_params = {
